...
class GPT2Attention(nn.Module):
    ...
    def forward(self, hidden_states, layer_past=None, prompt_embeds=None, attention_mask=None, head_mask=None, encoder_hidden_states=None, encoder_attention_mask=None, use_cache=False, output_attentions=False, ):
        if encoder_hidden_states is not None:
            if not hasattr(self, "q_attn"):
                raise ValueError("If class is used as cross attention, the weights `q_attn` have to be defined. "
...
class GPT2Block(nn.Module):
    ...
    def forward(self, hidden_states, layer_past=None, prompt_embeds=None, attention_mask=None, head_mask=None, encoder_hidden_states=None, encoder_attention_mask=None, use_cache=False, output_attentions=False, ):
        ...
        attn_outputs = self.attn(hidden_states, layer_past=layer_past, prompt_embeds=prompt_embeds, attention_mask=attention_mask, head_mask=head_mask, use_cache=use_cache, output_attentions=output_attentions, )
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids=None, past_key_values=None, prompt_embeds=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, encoder_hidden_states=None, encoder_attention_mask=None, use_cache=None, output_attentions=None, output_hidden_states=None, return_dict=None, ):
        ...
        if attention_mask is not None:
            if attention_mask.dim() == 3:
                if prompt_embeds is not None:
                    attention_mask = torch.nn.functional.pad(attention_mask, (prompt_embeds.shape[-2], 0, 0, 0), 'constant', value=1)
            ...
            attention_mask = attention_mask.to(dtype=self.dtype)  # fp16 compatibility #todo
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                outputs = torch.utils.checkpoint.checkpoint(create_custom_forward(block), hidden_states, None, attention_mask, head_mask[i], encoder_hidden_states, encoder_attention_mask, )
            else:
                outputs = block(hidden_states, layer_past=layer_past, prompt_embeds=prompt_embeds[i] if prompt_embeds is not None else None, attention_mask=attention_mask, head_mask=head_mask[i], encoder_hidden_states=encoder_hidden_states, encoder_attention_mask=encoder_attention_mask, use_cache=use_cache, output_attentions=output_attentions, )
...
class PromptGPT2forCRS(GPT2PreTrainedModel):
    ...
    def prepare_inputs_for_generation(self, input_ids, past=None, prompt_embeds=None, **kwargs):
        ...
        if attention_mask is not None and position_ids is None:
            ...
            position_ids = None
        return {"input_ids": input_ids, "past_key_values": past, "prompt_embeds": prompt_embeds, "use_cache": kwargs.get("use_cache"), "position_ids": position_ids, "attention_mask": attention_mask, "token_type_ids": token_type_ids, "conv": True}

    def forward(self, input_ids=None, past_key_values=None, prompt_embeds=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, inputs_embeds=None, encoder_hidden_states=None, encoder_attention_mask=None, use_cache=None, output_attentions=None, output_hidden_states=None, rec=False, pre=False, entity_embeds=None, entity_vector=None, rec_labels=None, conv=False, conv_labels=None, return_dict=True, ):
        transformer_outputs = self.transformer(input_ids, past_key_values=past_key_values, prompt_embeds=prompt_embeds, attention_mask=attention_mask, token_type_ids=token_type_ids, position_ids=position_ids, head_mask=head_mask, inputs_embeds=inputs_embeds, encoder_hidden_states=encoder_hidden_states, encoder_attention_mask=encoder_attention_mask, use_cache=use_cache, output_attentions=output_attentions, output_hidden_states=output_hidden_states, return_dict=return_dict, )
        ...
        return MultiOutput(conv_loss=loss, logits=lm_logits, rec_loss=rec_loss, rec_logits=rec_logits, past_key_values=transformer_outputs.past_key_values, hidden_states=transformer_outputs.last_hidden_state, attentions=transformer_outputs.attentions, cross_attentions=transformer_outputs.cross_attentions, )
